    ...
    IAvaloniaConverter<ComboBox>
{
    ...
    public static bool MemberHasValue(ComboBox target, string member, object? value)
    {
        ...
        if (member == "SelectionBoxItem")
        {
            return object.Equals(target.SelectionBoxItem, value);
        }
        if (member == "PlaceholderText")
        {
            return object.Equals(target.PlaceholderText, value);
        }
        if (member == "PlaceholderForeground")
        {
            return object.Equals(target.PlaceholderForeground, value);
        }
